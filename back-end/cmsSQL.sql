...
value ("History", 2, false);
insert into webpage(name, parentId, isHome)
value ("Mission", 2, false);
insert into webpage(name, parentId, isHome)
...
value (1, "Home Welcome Header", "Welcome!", "h1");
insert into Element(webpageId, name, content, `type`)
value (1, "Home Welcome Paragraph", "This is the home page.", "p");
insert into Element(webpageId, name, content, `type`)
value (2, "About Header 1", "About the Company", "h1");
insert into Element(webpageId, name, content, `type`)
value (2, "About Paragraph 1", "This company is awesome! Totally spend all your money here.", "p");
insert into Element(webpageId, name, content, `type`)
value (3, "Contact Header 1", "Contact Information", "h1");
insert into Element(webpageId, name, content, `type`)
value (3, "Contact Paragraph 1", "Idk what to put here.", "p");
insert into Element(webpageId, name, content, `type`)
value (4, "History Paragraph 1", "Some history about this place.", "p");
insert into Element(webpageId, name, content, `type`)
value (5, "Mission Paragraph 1", "We are awesome.", "p");
insert into Element(webpageId, name, content, `type`)
value (6, "Address Paragraph 1", "8484 Unicorn Rd", "p");
insert into Element(webpageId, name, content, `type`)
value (7, "Email Paragraph 1", "UnicornsAreTheBest@superhappyfunland.sparkles", "p");
